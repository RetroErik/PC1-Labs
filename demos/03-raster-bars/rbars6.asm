; ============================================================================
; RBARS3.ASM - Raster Bar Demo v3: Palette Cycling Animation
...
;   - Static pre-computed pattern table with scroll offset
;   - C64-style palette rotation during VBLANK for liquid effect
;   - Palette entries cycle smoothly for hypnotic visual animation
;
; LEARNING FOCUS:
;   Animation: adding palette cycling, VBLANK-safe register updates
;
; Controls:
;   Any key - Exit to DOS
; ============================================================================
