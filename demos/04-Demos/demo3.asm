...
.open_file:
    ...
    ; Decode BMP into RAM buffer (not directly to VRAM)
    call decode_bmp
...
draw_strip:
    ...
    mov bh, al                  ; Save starting Y in BH
    
    ; Prepare the fill byte (two pixels of same palette index)
    mov al, bl
    ; NEC V40 compatible: shl al, 4 -> use CL
    mov cl, 4
    shl al, cl
    or bl, al                   ; BL = packed pixels (e.g., 0xEE for palette 14)
