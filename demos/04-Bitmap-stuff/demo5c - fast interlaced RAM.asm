; ============================================================================
; DEMO5C.ASM - Scrolling BMP Image (Interlaced RAM Buffer)
...
;   sine-wave Lissajous motion. Uses an INTERLACED RAM buffer that mirrors
;   VRAM layout for faster REP MOVSW block copies.
;
;   Compare with demo5b which uses a LINEAR RAM buffer (simpler addressing
;   but requires per-row bank calculation when copying to VRAM).
;
; ============================================================================
; RAM BUFFER DESIGN
; ============================================================================
